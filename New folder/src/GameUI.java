...
public class GameUI extends JFrame {
    ...
    public GameUI() {
        ...
        SoundManager.playMusicLoop("sounds/bg_music.wav");
        ...
        optionMenu.setOptionAction(new OptionMenu.OptionAction() {
        @Override
        public void onBack() {
            startMenu.setEnabled(true); // ⭐ bật lại
        ...
        mainContainer.add(optionMenu, "OPTION"); // ✅ thêm dòng này
        mainContainer.add(recordScreen, "RECORD");
        ...
        startMenu.setMenuAction(new StartMenu.MenuAction() {
            ...
            public void onOptions() {
                SoundManager.playSound("sounds/click.wav");
                cardLayout.show(mainContainer, "OPTION");
            ...
            public void onRecord() {
                cardLayout.show(mainContainer, "RECORD");
            }
    ...
    private void checkWin(int newScore) {
        recordManager.addRecord(newScore, currentLevelIndex);
        if (overlayShowing)
            return;
    ...
    private void onLevelLose() {
        recordManager.addRecord(currentScore, currentLevelIndex);
        if (overlayShowing)
            return;
        overlayShowing = true;
        header.stopTimer();
        SoundManager.playSound("sounds/gameover_1.wav");
